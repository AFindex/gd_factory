...
public static class FactoryIndustrialStandards
{
    ...
    public static string GetInteriorPreviewSummary(BuildPrototypeKind kind)
    {
        return kind switch
        {
            ...
            BuildPrototypeKind.DebugOreSource => "无成本按配方持续输出单种矿物与基础原料，用于快速验证供料链。",
            BuildPrototypeKind.DebugPartSource => "无成本按配方持续输出单种板材与中间件，用于快速验证加工和缓存。",
            BuildPrototypeKind.DebugCombatSource => "无成本按配方持续输出单种战备与维护补给，用于快速验证炮塔和支援链。",

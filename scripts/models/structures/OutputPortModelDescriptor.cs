...
public static class OutputPortModelDescriptor
{
    public static void BuildModel(IModelBuilder builder, FactorySiteKind siteKind)
    {
        ...
        builder.AddBox("OutputLatch", new Vector3(deckWidth * 0.24f, 0.16f, deckDepth * 0.42f), tipColor.Lightened(0.10f), new Vector3(deckWidth * 0.26f, 0.34f, 0.0f));
    }
}

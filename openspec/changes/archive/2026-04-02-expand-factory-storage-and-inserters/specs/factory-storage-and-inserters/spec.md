...
The game SHALL allow the player to inspect a storage structure and view its current buffered contents through a dedicated panel while in interaction mode.
...
- **THEN** the game opens a storage panel bound to that structure and displays its current buffered contents

...
The game SHALL let a buildable structure declare a footprint as a set of local occupied cells relative to an anchor, and the resolved occupied cells SHALL rotate with the structure's facing in both the world sandbox and mobile-factory interiors.

# mobile-factory-child-structures Specification

## Purpose
Define world-side child structures deployed by mobile-factory attachments, including ownership, lifecycle cleanup, and durability feedback.

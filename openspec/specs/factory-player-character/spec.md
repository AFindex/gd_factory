# factory-player-character Specification

## Purpose
Define the player character, player-facing HUD, and inventory-driven placement flow used as the default interaction anchor in the factory demos.
